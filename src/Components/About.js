	...
	return (
		<Modal
			...
			<Modal.Body>
				...
				<br></br>Use the player at the top to change the song, or buttons below to change the season. I didn't want to force a playlist on your account so there is no autoplay - use the button above the songs to save the playlist if you like it! Created using React,
